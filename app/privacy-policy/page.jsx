        ...
        <div className="prose prose-lg max-w-none">
          <motion.section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              At Harika Nusantara, we are committed to protecting your privacy and handling your personal information with care. This Privacy Policy describes how we collect, use, store, and protect your information when you visit our
