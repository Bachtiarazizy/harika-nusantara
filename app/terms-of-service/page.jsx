      ...
      <motion.header className="bg-[#392E20] py-16 px-4" initial="hidden" animate="visible" variants={containerVariants}>
        <div className="max-w-4xl mx-auto">
          <motion.div className="text-center">
            ...
            <p className="text-lg text-gray-100 max-w-2xl mx-auto">These terms govern your use of our website and services. Please read them carefully before engaging with Harika Nusantara.</p>
          </motion.div>
        </div>
      </motion.header>
      ...
      <motion.main className="max-w-4xl mx-auto px-4 py-16" initial="hidden" animate="visible" variants={containerVariants}>
        ...
        <div className="prose prose-lg max-w-none">
          <motion.section className="mb-12">
            ...
            <p className="text-gray-700 leading-relaxed">
              By accessing or using the Harika Nusantara website and services, you agree to be bound by these Terms of Service and our Privacy Policy. If you do not agree to these terms, please do not use our services.
            </p>
          </motion.section>
          ...
          <motion.section className="mb-12">
            ...
            <p className="text-gray-700 mb-4">
              All content on this website, including but not limited to text, images, logos, product descriptions, and design elements, is the property of Harika Nusantara and is protected by intellectual property laws.
            </p>
            <ul className="list-disc pl-6 text-gray-700 space-y-2">
          ...
          <motion.section className="mb-12">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-gray-700">
                  To the fullest extent permitted by law, Harika Nusantara shall not be liable for any indirect, incidental, consequential, or punitive damages arising from your use of our website or services. Our total liability is limited
                  to the value of the specific transaction in question.
                </p>
              </div>
        ...
        <motion.section className="mt-16 p-8 bg-gray-50 rounded-2xl border border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a href="mailto:info@harikanusantara.com" className="inline-flex items-center gap-2 px-6 py-3 bg-[#392E20]  text-white rounded-lg hover:bg-[#392E20]/80  transition-colors font-medium">
