        ...
        {filteredPosts.length > 0 ? (
          ...
          <div className="max-w-6xl mx-auto px-4 text-center py-16">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-600 mb-8">{searchQuery ? `No articles match your search for "${searchQuery}". Try different keywords or explore all our articles.` : "No articles are currently available. Please check back later."}</p>
